            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  required
                  placeholder="Tell us about your ground, budget, and scoreboard needs..."
                  rows={5}
                  className="mt-1"
                />
              </div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">info@ballebaaz.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                ...
                <div>
                  <h3 className="font-semibold">Manufacturing Location</h3>
